...
This document explains the processes and practices recommended for contributing enhancements to the Jenkins agent Operator.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/jenkins-agent-k8s-operator)
...
Canonical welcomes contributions to the Jenkins agent Operator. Please check out our
